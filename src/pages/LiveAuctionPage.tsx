    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-indigo-50 via-violet-50 to-amber-50 pt-24 pb-20">
      ...
      <div className="flex-1 w-full px-4 max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-10">
          ...
          <Link to="/contact" className="inline-flex items-center px-6 py-3 rounded-full bg-gradient-to-r from-amber-400 via-amber-500 to-yellow-400 text-slate-950 font-semibold shadow-lg hover:from-amber-500 hover:to-yellow-500 transition">
            Speak with us
          </Link>
        </div>

        <div className="rounded-3xl bg-white p-10 shadow-xl border border-slate-200 text-center">
          <div className="inline-flex items-center justify-center h-20 w-20 rounded-full bg-indigo-100 text-indigo-700 mx-auto mb-6 text-4xl">🎯</div>
